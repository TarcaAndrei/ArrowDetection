...
class DinoVisionTransformer(nn.Module):
    ...
    def forward_features_list(self, x_list: list[torch.Tensor], masks_list: list[torch.Tensor]):
    ...
    def forward_features(self, x: torch.Tensor | list[torch.Tensor],
                         ...
                         ) -> list | dict[str, torch.Tensor | list[torch.Tensor] | None]:
    ...
    def _get_intermediate_layers_not_chunked(self, x: torch.Tensor, n: int | Sequence = 1) -> list:
    ...
    def _get_intermediate_layers_chunked(self, x: torch.Tensor, n: int | Sequence = 1) -> list:
        x = self.prepare_tokens_with_masks(x)
    ...
    def forward(self, *args) -> list | dict[str, torch.Tensor | list[torch.Tensor] | None]:
