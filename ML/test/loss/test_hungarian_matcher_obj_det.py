...
def test_perfect_match(matcher: torch.nn.Module) -> None:
...
def test_cost_weight_variation() -> None:
    # Test case with different weights for each cost component
    matcher_with_diff_costs = HungarianMatcher(
...
def test_partial_match(matcher: torch.nn.Module) -> None:
